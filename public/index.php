...
// Si no existe entonces será igual a /
$route = $_GET['route'] ?? '/';

function render($fileName, $params=[]){
    ob_start(); //Almacena en un buffer interno
    extract($params); //Extrae variables de un arreglo asociativo
    include $fileName;
    return ob_get_clean();
}
...
// Rutas a las diferentes vistas del proyecto
